              ...
              <Nav pullRight>
                {
                  this.state.authed
                  ? ([
                      <LinkContainer to='/weather' key={1}><NavItem eventKey={1}>Weather Forecast</NavItem></LinkContainer>,
                      <LinkContainer to='/checkin' key={2}><NavItem eventKey={2}>Check in</NavItem></LinkContainer>,
                      <LinkContainer to='/logs' key={3}><NavItem eventKey={3}>Watering Logs</NavItem></LinkContainer>,
                      <LinkContainer to='/chat' key={4}><NavItem eventKey={4}>Chat</NavItem></LinkContainer>,
